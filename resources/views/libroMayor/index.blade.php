...
<!-- Content -->
    {{-- <div id="content"> --}}
      <div class="container">
          <section class="py-5">
            <h1 class="font-weight-bold mb-0" align="center">LIBRO MAYOR</h1>
 ...
 <!-- MENSAJE ALERTA EXITOSA -->
  ...
  <section>
          <table id="tablaLibroMayor"  class="table table-dark" style="width:100%" >
            <thead>
            ...
            <tbody>
                @forelse ($detalleLibroDiario as $dato)
                <tr class="table-secondary  roboto-medium">
                    <td>{{ $dato->libroDiario->id }}</td>
                    <td>{{ $dato->libroDiario->fecha_hora}}</td>
                    <td>{{ $dato->codigo}}</td>
                    <td>{{ $dato->cuenta}}</td>
...
<script>
$(function(){
    $("#tablaLibroMayor").DataTable(dataTableOpciones);
