...
<!-- Content -->
    {{-- <div id="content"> --}}
      <div class="container">
          <section class="py-5">
            <h1 class="font-weight-bold mb-0" align="center">LISTA DE DETALLE NOMENCLATURA</h1>
 ...
 <!-- MENSAJE ALERTA EXITOSA -->
  ...
  <div class="container-fluid">
    <div class="block mb-8">
        <a href="{{ route('planCuentas.create') }}" class="btn btn-primary"><i class="bi bi-plus-circle-fill"></i>&nbsp; Añadir</a>
    </div>
  ...
  {{-- TABLA PARA VISUALIZAR NOMECLATURA AGREGADA --}}
            ...
            <legend><i class="bi bi-table"></i> &nbsp; Tabla de detalle de información nomenclatura</legend>
            <br>
        <div class="card">
            <div class="card-body">
            <div class="table-responsive">
                ...
                <section>
                    <table id="tableDetallePlanCuenta"  class="table table-dark" style="width:100%">
                        <thead>
                          <tr class="roboto-medium">
                            ...
                            <th>CUENTA AUXILIARES</th>
                            {{-- <th>EDITAR</th>
                            <th>ELIMINAR</th> --}}
                          </tr>
                        </thead>
                        <tbody>
                            @forelse ($detallePlanCuentas as $dato)
                            <tr class="table-secondary  roboto-medium">
                                <td>{{ $dato->id }}</td>
                                <!-- planCuentaAuxiliar() es la funcion llamada del modelo DetallePlanCuentaAuxiliar -->
                                <td>{{ $dato->planCuentaAuxiliar->claseCuenta->codigo_cuenta }} {{ $dato->planCuentaAuxiliar->claseCuenta->nombre_cuenta }}</td>
                                <td>{{ $dato->planCuentaAuxiliar->grupoCuenta->codigo_cuenta }} {{ $dato->planCuentaAuxiliar->grupoCuenta->nombre_cuenta }}</td>
                                <td>{{ $dato->planCuentaAuxiliar->estadoFinanciero->estadoFinanciero }}</td>
...
<script>
$(function(){
    $("#tableDetallePlanCuenta").DataTable(dataTableOpciones);
...
let dataTableOpciones = {
            ...
            lengthMenu:[15,25,50],
            columnDefs: [{orderable:false, target:[1,2,3,4]}
        ],
        pageLength: 10,
        language: {
    "aria": {
