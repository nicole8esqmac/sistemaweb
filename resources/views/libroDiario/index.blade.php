...
<!-- Content -->
    {{-- <div id="content"> --}}
      <div class="container">
          <section class="py-5">
            <h1 class="font-weight-bold mb-0" align="center">LISTADO LIBRO DIARIO</h1>
 ...
 <!-- MENSAJE ALERTA EXITOSA -->
  ...
  <div class="container-fluid">
    <div class="block mb-8">
        <a href="{{ route('libroDiario.create') }}" class="btn btn-primary"><i class="bi bi-plus-circle-fill"></i>&nbsp; Añadir</a>
    </div>
    <br>
    <div class="card">
        <div class="card-body">
  ...
  <section>
          <table id="tablaLibroDiario"  class="table table-dark" style="width:100%" >
            <thead>
            ...
            <tbody>
                ...
                <tr class="table-secondary  roboto-medium">
                    ...
                    {{-- <td>{{ $dato->impuesto}}</td> --}}
                    <td>Q {{ $dato->total}}</td>
                    <td><span class="badge rounded-pill text-bg-info">{{ $dato->estado}}</span></td>
                    <td>
                        <form action="{{ route("libroDiario.show", $dato->id) }}" method="get">
                    ...
                    <td>
                        <form action="{{ route("libroDiario.destroy", $dato->id) }}" method="POST" onsubmit="return confirm('¿Desea cancelar el comprobante seleccionado ?');">
...
<script>
$(function(){
    $("#tablaLibroDiario").DataTable(dataTableOpciones);
