                            ...
                            <div class="nav-lateral-content" class="collapse navbar-collapse" id="navbarScroll">
                               ...
                               <section >
                                    <ul class="list-group">
                                        ...
                                        <a href="{{ route('libroCuentaAuxiliar') }}" class="style-icono"><i class="bi bi-file-earmark-medical style-icono2"></i><h6 class="style-texto">Movimientos</h6></a>
                                        ...
                                        <a href="{{ route('balanceGeneral') }}" class="style-icono"><i class="bi bi-file-post style-icono2"></i><h6 class="style-texto">Balance General</h6></a>
