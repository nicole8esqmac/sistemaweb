...
<!-- Content -->
    {{-- <div id="content"> --}}
      <div class="container">
          <section class="py-5">
            <h1 class="font-weight-bold mb-0" align="center">LISTADO CUENTA AUXILIAR</h1>
 ...
 <!-- MENSAJE ALERTA EXITOSA -->
  ...
  <div class="container-fluid">
    {{-- <div class="block mb-8">
        <a href="" class="btn btn-primary">Añadir Libro Diario</a>
    </div> --}}
    <br>
    <div class="card">
        <div class="card-body">
  ...
  <section>
          <table id="tablaLibroMovimientos"  class="table table-dark" style="width:100%" >
            ...
            <tbody>
                ...
                {{-- @forelse ($detalleLibroCuentaAuxiliar as $dato)
    @if ($dato->idLibroCuentaAuxiliar == 2)
        <tr class="table-secondary  roboto-medium">
            <td>{{ $dato->idLibroCuentaAuxiliar }}</td>
            <td>{{ $dato->codigo }}</td>
            <td>{{ $dato->cuenta }}</td>
            <td>{{ $dato->debitosLD }}</td>
            <td>{{ $dato->creditosLD }}</td>
