...
<!-- Content -->
    {{-- <div id="content"> --}}
      <div class="container">
          <section class="py-5">
            <h2 class="font-weight-bold mb-0"><i class="bi bi-file-earmark-text-fill"></i>&nbsp; Lista Proyectos</h2>
 ...
 <!-- MENSAJE ALERTA EXITOSA -->
     ...
     <div class="container-fluid">
        <div class="block mb-8">
            <a href="{{ route('manejoProyectos.create') }}" class="btn btn-primary"><i class="bi bi-plus-circle-fill"></i>&nbsp; Añadir</a>
        </div>
      ...
      <section>
        <div class="card">
          ...
          <div class="table-responsive">
              <table id="tableTituloProyecto"  class="table table-dark" style="width:100%">
                    <thead>
                    ...
                    <tbody>
                        @forelse ($manejoProyectos as $dato)
                        ...
                        <tr class="table-secondary  roboto-medium">
                            ...
                            <td class="text-center">
                              <form action="{{ route("manejoProyectos.show", $dato->id) }}" method="get">
                                <button class="btn btn-warning btn-sm"><i class="bi bi-file-text-fill"></i></button>
                              </form>
                            </td>
                            <td class="text-center">
                              <form action="{{ route("manejoProyectos.edit", $dato->id) }}" method="get">
                                <button class="btn btn-secondary btn-sm"><i class="bi bi-pencil-fill"></i></button>
                              </form>
                            </td>
                            {{-- <td class="text-center">
                              <form action="{{ route("manejoProyectos.destroy", $dato->id) }}" method="POST" onsubmit="return confirm('Esta seguro?');">
...
<script>
$(function(){
    $("#tableTituloProyecto").DataTable(dataTableOpciones);
