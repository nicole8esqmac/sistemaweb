...
<!-- Content -->
    {{-- <div id="content"> --}}
      <div class="container">
          <section class="py-5">
            <h1 class="font-weight-bold mb-0" align="center">LISTADO FASE 2 PROYECTO - BENEFICIARIO</h1>
 ...
 <!-- MENSAJE ALERTA EXITOSA -->
  ...
  <div class="container-fluid">
    <div class="block mb-8">
        <a href="{{ route('fase2Proyectos.create') }}" class="btn btn-primary"><i class="bi bi-plus-circle-fill"></i>&nbsp; Añadir</a>
    </div>
    <br>
    <div class="card">
        <div class="card-body">
  ...
  <section>
          <table id="tablaFase2Proyectos"  class="table table-dark" style="width:100%" >
            <thead>
            ...
            <tbody>
                @forelse ($fase2Proyectos as $dato)
                <tr class="table-secondary  roboto-medium">
                    ...
                    <td>
                        <form action="{{ route("fase2Proyectos.show", $dato->id) }}" method="get">
                          <button class="btn btn-warning btn-sm"><i class="bi bi-file-text-fill"></i></button>
                        </form>
                    </td>
                    <td>
                        <form action="{{ route("fase2Proyectos.edit", $dato->id) }}" method="get">
...
<script>
$(function(){
    $("#tablaFase2Proyectos").DataTable(dataTableOpciones);
